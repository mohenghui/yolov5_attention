...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5m_C3CA.yaml', help=' path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/my_person.yaml', help='dataset.yaml path')
